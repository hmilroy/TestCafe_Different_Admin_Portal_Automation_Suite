...
let ownerSignLinkStatus = false;
let ownerSignLink = null;

function getOwnerSignHash(personId){
    return PersonService.genareteOwnerLoginHash(personId)
        .then(result => {
        ...
        <div className="inner-form view-person">
            <div className="form-group row element main-selection">
                ...
                <select
                    ...
                    <option value={props.person.role}>{props.type.toUpperCase()}</option>
                </select>
            </div>
            {(props.type != 'tradie' && props.type != 'inspector') && (
                <div className="form-group row element property-address">
                    <label className="form-label col-xs-4">Property</label>
                    <a className="form-input col-xs-8 address-field" value={OptimalHash.encode(props.propertyId)}
            ...
            <div className="form-group row element">
                ...
                <input className="form-input col-xs-5"
                       value={props.person.email}
                       onChange={props.onEmailChange}
                       disabled={props.editDisabled}/>
                {props.editDisabled && props.type == 'owner' && (<div className="bottom-buttons col-xs-2">
                    ...
                    <div className="form-group row element single-input address-input mappify-address">
                        ...
                        <div className="col-xs-8 row">
                            <div className="col-xs-2 no-padding">
                                <ReactPhoneInput
                                    className="form-input col-xs-2"
                                    onChange={props.onAddressCountryFlagChange}
                                    value={props.addressCountryCode}
                                    disabled={props.editDisabled}/>
                            </div>
...
ViewPersonForm.propTypes = {
    ...
    onCustomAddressChange: React.PropTypes.func,
    onResendClick: React.PropTypes.func,
    onAddressCountryFlagChange: React.PropTypes.func,
};
